...
file_path = 'g:/Meine Ablage/Berufsschule/Lernseite/learning-space-main/wirtschaft.html'

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Extract content between <!-- Tab Navigation --> and <!-- Footer -->
# Note: we also want to extract the tabs navigation and remove it, we will put our own.
# Actually, the original has <div class="tab-navigation">...</div>
# Then <!-- TAB 1: THEORIE -->
# We want to extract starting from <!-- TAB 1: THEORIE --> up to <!-- Footer -->

body_match = re.search(r'<!-- TAB 1: THEORIE -->(.*?)<!-- Footer -->', content, re.DOTALL)
if not body_match:
...
# Replace old tab classes with new ones
body_content = body_content.replace('class="tab-content active"', 'class="tab-pane active"')
body_content = body_content.replace('class="tab-content"', 'class="tab-pane"')
...
print('Updated wirtschaft.html successfully.')
